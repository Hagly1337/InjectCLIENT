...
void LogShaders(){
	...
	plthook_replace(plthook, "glGetUniformLocation", (void *)new_glGetUniformLocation, (void **)&old_glGetUniformLocation);
...
void Wallhack(){
	plthook_t *plthook;
	if (plthook_open(&plthook, "lib/arm64/libunity.so") == 0) {
	plthook_replace(plthook, "glDrawElements", (void *)new_glDrawElements, (void **)&old_glGetUniformLocation);
	plthook_close(plthook);
    }
    DobbyHook((void*)glDrawElements, (void*)new_glDrawElements,(void**)&old_glDrawElements);
}
